	...
	<div class="container-xxl py-5">
		<div class="container">
			<div class="text-center wow fadeInUp" data-wow-delay="0.1s">
				<h3 class="section-title bg-white text-center text-primary px-3"> Explore  ${packageType}</h3>
				<br>
				<hr>
			</div>
...
<script type="text/javascript">
	...
	$(document).ready(function () {
	    ...
	    if (!packageTypeInput) {
	        console.error("Hidden input field with ID 'packageType' not found.");
	        //alert("Error: Package type input field not found.");
	        return;
	    }

	    const packageType = packageTypeInput.value;
	    if (!packageType) {
	       // alert("Error: Package type is missing. Please select a valid package type.");
	        console.error("Package type is empty.");
	        return;
	    }

	   // alert("Package type found: " + packageType); // Optional alert to confirm packageType value
	    getAllPackages(packageType); // Pass packageType to the function
	});

	function getAllPackages(packageType) {
		    $.ajax({
