...
<head>
    ...
    <style>
        ...
        #designationDropdown option {
            background-color: rgba(0, 0, 0, 0.5); /* Same transparency for options */
            color: white;
        }
    </style>
</head>
            ...
            <div class="d-inline-flex align-items-center" style="height: 80px;">
                <a href="" class="navbar-brand p-0">
                    <h1 class="text-primary m-0">
                        ...
                        Shri Gajanan Yatra Company Pvt. Ltd
                    </h1>
                </a>
            </div>
        </div>
...
<!-- Navbar -->
<div id="navbar" class="container-fluid p-0" style="position: fixed; top: 80px; width: 100%; z-index: 1029; background-color: #fff;">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" id="domesticDropdown" data-bs-toggle="dropdown">Domestic</a>
                    <div class="dropdown-menu m-0" id="regionDropdown"></div>
                </div>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" id="internationalDropdownToggle" data-bs-toggle="dropdown">International</a>
        ...
        <div class="container py-5">
            <div class="row justify-content-center py-5">
                <div class="col-lg-10 text-center">
                    <h1 class="display-4 text-white fw-bold mb-2 animated fadeInDown">
                        Welcome To <span class="text-warning"><br>Shri Gajanan Yatra Company Pvt. Ltd</span>
                        <br><small class="text-light fs-4">Since 2014</small>
                    </h1>
                    ...
                    <p class="fs-5 text-light animated fadeInUp">
                        ...
                        <a href="https://wa.me/9552014476" class="btn btn-success px-4 py-2 rounded-pill text-white d-inline-flex align-items-center gap-2">
...
//             navbar.style.display = "block"; // Hide Navbar on Scroll
//             topbar.style.position = "fixed";
//         } else {
//             navbar.style.display = "block"; // Show Navbar on Top
//             topbar.style.position = "fixed";
//         }
//     });
</script>
